...
describe('Indexes', function () {
    ...
    it('creates a table with fulltext index', function () {
        ...
        $exists = schema('sqlite')->hasTable('articles')->await();
        expect($exists)->toBeTruthy();
    });
    ...
    it('creates table with various spatial types', function () {
        ...
        $exists = schema('sqlite')->hasTable('geo_test')->await();
        expect($exists)->toBeTruthy();

        schema('sqlite')->dropIfExists('geo_test')->await();
    });
    ...
    it('creates table with SRID specification', function () {
        ...
        schema('sqlite')->dropIfExists('stores')->await();
    });
