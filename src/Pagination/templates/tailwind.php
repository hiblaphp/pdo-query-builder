    ...
    <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            <?php for ($page = $start; $page <= $end; $page++): ?>
                ...
                <?php else: ?>
                    <a href="<?= htmlspecialchars($paginator->url($page)); ?>" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                        <?= $page; ?>
                    </a>
                <?php endif; ?>
            <?php endfor; ?>
            ...
            <?php if ($end < $lastPage): ?>
                ...
                <?php endif; ?>
                <a href="<?= htmlspecialchars($paginator->url($lastPage)); ?>" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                    <?= $lastPage; ?>
                </a>
            <?php endif; ?>
